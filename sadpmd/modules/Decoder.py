...
class Decoder(nn.Module):
    ...
    def forward(self, state_hidden, arc_masks):
        ...
        # The first part of hidden state is used for arc prediction and the last part is used for relation prediction. 
        # Below is an equivalent code for the above lines 23, 24, 25.
        # arc_state_hidden = state_hidden[:, :, :self.arc_num]
        # rel_state_hidden = state_hidden[:, :, self.arc_num:]
