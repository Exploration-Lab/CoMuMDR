...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name_or_path', type=str, default='sentence-transformers/paraphrase-xlm-r-multilingual-v1') # changed
    ...
    parser.add_argument('--hidden_size', type=int, default=768) # changed
